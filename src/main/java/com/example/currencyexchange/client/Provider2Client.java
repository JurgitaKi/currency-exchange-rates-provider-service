...
/**
 * Exchange rate client backed by Provider 2 service.
 */
@Slf4j
@Component
public class Provider2Client implements ExchangeRateClient {

    private static final String PROVIDER_NAME = "Provider2";

    private final WebClient webClient;

    public Provider2Client(
            @Value("${exchange.providers.provider2.base-url:http://localhost:8082}") String baseUrl,
